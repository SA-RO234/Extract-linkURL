...
<body class="">
    <div class="md:w-[50%] w-[90%] m-auto select-none p-[100px_0px]">
        <h1 class="text-center text-white text-[2.5em] md:font-bold font-extrabold pb-[50px]">Extract URL for Get <span class="text-red-700">[</span> Email, PhoneNumber and Images <span class="text-red-700">]</span> Not Duplicate.</h1>
        <form id="formData" class="flex w-full md:gap-0 gap-[30px] flex-wrap md:justify-between justify-center items-center ">
            <div class="relative md:w-[70%]  w-[100%]">
                <div class="rounded-lg border border-gray-700 bg-black shadow-sm flex items-center overflow-hidden">
                    <span class="text-gray-400 pl-4 pr-1 text-sm">http://</span>
                    <input required type="text" name="url" placeholder="site.com" class="w-full bg-transparent py-3 px-0 text-gray-300 outline-none placeholder-gray-400 text-sm">
                    <div class="p-3 text-gray-400 hover:text-gray-300 transition-colors">
            ...
            <button type="submit" class="btn relative text-white h-[50px] md:w-[18%] w-[50%]">
                <span>Extract</span>
